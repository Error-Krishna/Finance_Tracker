...
def budget_status():
    ...
    monthly_budget = budget_doc["budget"] if budget_doc else None
    remaining_budget = (monthly_budget if monthly_budget is not None else total_income) - total_expenses
